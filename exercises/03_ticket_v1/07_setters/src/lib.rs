...
impl Ticket {
    ...
    pub fn new(title: String, description: String, status: String) -> Ticket {
        // call validation logic to make New a cleaner init 
    ...
    // setters, set_*() will borrow the Ticket instance to set the field
...
// validation functions to that only need the panic statements and reference to string
