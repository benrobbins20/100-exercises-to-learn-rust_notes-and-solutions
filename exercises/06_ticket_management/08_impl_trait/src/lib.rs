...
impl TicketStore {
    ...
    // RPIT example, return pos impl trait
    // this returns something that implements Iterator trait for ticket refs
    // returns .filter, which is anonymous and 'opaque typed'
